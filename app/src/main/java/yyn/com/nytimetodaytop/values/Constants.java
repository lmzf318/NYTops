package yyn.com.nytimetodaytop.values;

/**
 * Created by jiy on 2017-04-11.
 */
public class Constants {
    public final static String NYTOPS_API_KEY = "nQ1IQngbAXE0oLj4RVi8TElXtkPAepgP";
    public final static String BASE_URL = "https://api.nytimes.com/svc/topstories/v2/";
    public final static String FORMAT = "json";

    // categories of news type
    public final static String CAT_HOME = "home";
